...
export class AddBaseDatabase1664267522103 implements MigrationInterface {
  name = 'AddBaseDatabase1664267522103';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "posts" (
                ...
                CONSTRAINT "CHK_deb6cafb3599358049bdd953de" CHECK (
                    (
                        "mediaUrl" is null
                        and "mediaType" is null
                    )
                    or (
                        "mediaUrl" is not null
    ...
    await queryRunner.query(`
            CREATE TABLE "likes" (
                ...
                CONSTRAINT "PK_74b9b8cd79a1014e50135f266fe" PRIMARY KEY ("postId", "userId")
            )
        `);
    await queryRunner.query(`
            ALTER TABLE "posts"
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            CREATE VIEW "aggregated_posts" AS with postlikes as (
                select l."postId",
