...
export class AddBaseDatabase1663858351707 implements MigrationInterface {
    name = 'AddBaseDatabase1663858351707'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "posts" ("id" character varying(26) NOT NULL, "creator" character varying NOT NULL, "text" character varying NOT NULL, "mediaUrl" character varying, "mediaType" character varying, "parentId" character varying, CONSTRAINT "CHK_deb6cafb3599358049bdd953de" CHECK (("mediaUrl" is null and "mediaType" is null) or ("mediaUrl" is not null and "mediaType" is not null)), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "likes" ("postId" character varying(26) NOT NULL, "userId" character varying NOT NULL, CONSTRAINT "PK_74b9b8cd79a1014e50135f266fe" PRIMARY KEY ("postId", "userId"))`);
